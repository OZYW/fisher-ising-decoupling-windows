...
plt.savefig(os.path.join(fig_dir, 'legacy_control_experiment_n16_results.png'), dpi=150, bbox_inches='tight')
print("\nSaved figure: figures/legacy_control_experiment_n16_results.png")
